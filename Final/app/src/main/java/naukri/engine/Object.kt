...
abstract class Object : Serializable {
    ...
    companion object {
        ...
        fun instantiateNonCopy(gameObject: GameObject, position: Vector2): GameObject {
            val res = instantiateNonCopy(gameObject)
            res.transform.position = position
            return res
        }

        fun instantiateNonCopy(gameObject: GameObject, parent: Transform): GameObject {
            val res = instantiateNonCopy(gameObject)
